...
const WhatsAppButton = () => {
  ...
  return (
    <motion.a
      ...
      className="group fixed bottom-6 right-6 z-50 flex cursor-pointer items-center gap-2 rounded-full bg-primary px-4 py-3 text-primary-foreground shadow-gold transition-all duration-300 hover:opacity-90"
